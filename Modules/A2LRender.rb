...
def A2LRender._CANAPE_Create_Ini()
  ...
  def A2LRender._Characteristic_Identical(inputs)
    Mustache.template_file=File.dirname(__FILE__) + Templates + "Characteristic-Identical.mustache"
    total=""
    for key in inputs.keys
      total+=Mustache.render(A2LRender._to_s(inputs[key]))
    end
  ...
  def A2LRender._Characteristic_Curve_Standard(inputs)
    Mustache.template_file=File.dirname(__FILE__) + Templates + "Characteristic-Curve-Standard.mustache"
    total=""
    for key in inputs.keys
      total+=Mustache.render(A2LRender._to_s(inputs[key]))
    end
  ...
  def A2LRender._Characteristic_Curve_Common(inputs)
    Mustache.template_file=File.dirname(__FILE__) + Templates + "Characteristic-Curve-Common.mustache"
    total=""
    for key in inputs.keys
      total+=Mustache.render(A2LRender._to_s(inputs[key]))
    end
  ...
  def A2LRender._Characteristic_Curve_Fix_Axis(inputs)
    Mustache.template_file=File.dirname(__FILE__) + Templates + "Characteristic-Curve-Fix-Axis.mustache"
    total=""
    for key in inputs.keys
      total+=Mustache.render(A2LRender._to_s(inputs[key]))
    end
  ...
  def A2LRender._Characteristic_Curve_Axis(inputs)
    Mustache.template_file=File.dirname(__FILE__) + Templates + "Characteristic-Curve-Axis.mustache"
    total=""
    for key in inputs.keys
      total+=Mustache.render(A2LRender._to_s(inputs[key]))
    end
  ...
  def A2LRender._Characteristic_Curve_Axis_Standard(inputs)
    Mustache.template_file=File.dirname(__FILE__) + Templates + "Characteristic-Curve-Axis-Standard.mustache"
    total=""
    for key in inputs.keys
      total+=Mustache.render(A2LRender._to_s(inputs[key]))
    end
  ...
  def A2LRender._Characteristic_Curve_Axis_Rescale(inputs)
    Mustache.template_file=File.dirname(__FILE__) + Templates + "Characteristic-Curve-Axis-Rescale.mustache"
    total=""
    for key in inputs.keys
      total+=Mustache.render(A2LRender._to_s(inputs[key]))
    end
  ...
  def A2LRender._Characteristic_Curve_Monotony(inputs)
    Mustache.template_file=File.dirname(__FILE__) + Templates + "Characteristic-Curve-Monotony.mustache"
    total=""
    for key in inputs.keys
      total+=Mustache.render(A2LRender._to_s(inputs[key]))
    end
  ...
  def A2LRender._Characteristic_Map_Standard(inputs)
    Mustache.template_file=File.dirname(__FILE__) + Templates + "Characteristic-Map-Standard.mustache"
    total=""
    for key in inputs.keys
      total+=Mustache.render(A2LRender._to_s(inputs[key]))
    end
  ...
  def A2LRender._Characteristic_Curve(inputs)
    Mustache.template_file=File.dirname(__FILE__) + Templates + "Characteristic-Curve.mustache"
    total=""
    for key in inputs.keys
      total+=Mustache.render(A2LRender._to_s(inputs[key]))
    end
  ...
  def A2LRender._Characteristic_Map(inputs)
    Mustache.template_file=File.dirname(__FILE__) + Templates + "Characteristic-Map.mustache"
    total=""
    for key in inputs.keys
      total+=Mustache.render(A2LRender._to_s(inputs[key]))
    end
